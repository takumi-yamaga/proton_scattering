...
{   
  fPListCmd = new G4UIcmdWithAString("/proton_scattering/Physics",this);
  ...
  fListCmd = new G4UIcmdWithoutParameter("/proton_scattering/ListPhysics",this);
...
void PhysicsListMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  if( command == fPListCmd ) {
    if(fPhysicsList) {
      ...
      G4cout << "### PhysicsListMessenger WARNING: "
             << " /proton_scattering/Physics UI command is not available "
    ...
    if(fPhysicsList) {
      ...
      G4cout << "### PhysicsListMessenger WARNING: "
             << " /proton_scattering/ListPhysics UI command is not available "
             << "for reference Physics List" << G4endl;
    }
  }
}
